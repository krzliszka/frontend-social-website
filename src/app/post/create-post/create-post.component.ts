...
export class CreatePostComponent implements OnInit {
  ...
  constructor(private router: Router, private postService: PostService,
    private subsocialService: SubsocialService) {
    this.postPayload = {
      postName: '',
      url: '',
      description: '',
  ...
  ngOnInit() {
    this.createPostForm = new FormGroup({
      ...
      subsocialName: new FormControl('', Validators.required),
  ...
  createPost() {
    ...
    this.postPayload.subsocialName = this.createPostForm.get('subsocialName')?.value;
